...
For your convenience, an instance of parse-server for snowflake is running remotely on Heroku

#### Test with your snowflake app
* For your convenience, we have an instance of parse-server already running remotely on Heroku
